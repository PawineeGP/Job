                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user-profile.update',$user->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="text-center">
                            ...
                            @else
                            <img src="{{asset('uploads/avatar/'.$user->avatar)}}" class="rounded" alt="..." width="300" height="300">
                            @endif
                        </div>
                        <br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="line_id"   type="text" class="form-control" name="line_id" value="{{$user->line_id}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phonenumber"  type="text" class="form-control" name="phonenumber" value ="{{ $user->phonumber }}" >
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="fileURL" class="col-md-4 col-form-label text-md-right">Image-Profile :</label>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <a href="{{route('user-profile.index')}}" class="btn btn-danger">                                   
                                    กลับ
                                </a>
                            </div>
                        </div>
